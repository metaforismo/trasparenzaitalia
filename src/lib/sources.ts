...
export const publicSources: PublicSource[] = [
  {
    ...
    cadence: "Flusso operativo continuo; pubblicazione dati secondo il canale ufficiale",
    ...
    status: "integrazione",
    note: "Base primaria per leggere i flussi di cassa degli enti pubblici.",
  },
  {
    slug: "openbdap",
    name: "OpenBDAP",
    ...
    cadence: "Variabile per dataset",
    coverage: "Catalogo nazionale RGS",
    format: "CKAN API · CSV · open data",
    url: "https://bdap-opendata.rgs.mef.gov.it/content/api",
    status: "attiva",
    note: "Catalogo interrogabile via API CKAN; è il primo connettore server già presente nel progetto.",
  },
  {
    slug: "anac-bdncp",
    ...
    cadence: "Analytics aggiornato settimanalmente",
    ...
    status: "integrazione",
    note: "Per procedure, CIG, stazioni appaltanti, aggiudicazioni e ciclo di vita dei contratti.",
  },
  {
    slug: "art-4-bis",
  ...
  },
  {
    ...
    status: "integrazione",
    note: "Registro canonico per Codice IPA, codice fiscale, sito istituzionale e classificazione degli enti.",
  },
  {
    slug: "opencoesione",
    name: "OpenCoesione",
    ...
    format: "API · CSV",
    url: "https://opencoesione.gov.it/it/api-opencoesione/",
    status: "mappata",
  ...
  },
  {
    ...
    cadence: "Aggiornamento dichiarato per singolo incarico",
